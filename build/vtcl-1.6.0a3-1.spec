%define version 1.6.0a3

Summary:	Visual Tcl is an integrated development environment for Tcl/Tk 8.3.2 and later.
Name:		vtcl
Version:	%{version}
Release:	1
Icon:		title.gif
...
mkdir -p $RPM_BUILD_ROOT/opt/local/vtcl-%{version}/lib/ttd
...
mkdir -p $RPM_BUILD_ROOT/opt/local/vtcl-%{version}/lib/Widgets/tablelist
...
install -m 644 opt/local/vtcl-%{version}/lib/Help/about.ttd			$RPM_BUILD_ROOT/opt/local/vtcl-%{version}/lib/Help
...
install -m 644 opt/local/vtcl-%{version}/lib/ttd/*.tcl					$RPM_BUILD_ROOT/opt/local/vtcl-%{version}/lib/ttd
...
install -m 644 opt/local/vtcl-%{version}/lib/Widgets/tablelist/*.wgt	$RPM_BUILD_ROOT/opt/local/vtcl-%{version}/lib/Widgets/tablelist
install -m 644 opt/local/vtcl-%{version}/lib/Widgets/tablelist/*.gif	$RPM_BUILD_ROOT/opt/local/vtcl-%{version}/lib/Widgets/tablelist
...
install -m 644 opt/local/vtcl-%{version}/lib/Widgets/core/*.gif		$RPM_BUILD_ROOT/opt/local/vtcl-%{version}/lib/Widgets/core
install -m 644 opt/local/vtcl-%{version}/lib/Widgets/tix/*.wgt		$RPM_BUILD_ROOT/opt/local/vtcl-%{version}/lib/Widgets/tix
install -m 644 opt/local/vtcl-%{version}/lib/Widgets/tix/*.gif		$RPM_BUILD_ROOT/opt/local/vtcl-%{version}/lib/Widgets/tix
...
install -m 644 opt/local/vtcl-%{version}/lib/Widgets/blt/*.gif		$RPM_BUILD_ROOT/opt/local/vtcl-%{version}/lib/Widgets/blt
